...
const CIRCOM_FIELD_P = BigInt("21888242871839275222246405745257275088548364400416034343698204186575808495617");

function hash(message: BytesLike | Hexable | number | bigint): NumericString {
